...
enum {
    ...
    INIT_MEMORY = 3,
    MEM_DELTA_FINAL_MULTIPLE = 48,
};
double memory_delta = 0.0125;
double strategy_delta = 0.2;
...
int main() {
    ...
    write_memory_evolutionary_mg_observables(RUN_TIME, NUM_STRATEGIES_PER_AGENT, RNG_SEED, MAX_AGENT_POP, INIT_MEMORY, MEM_DELTA_FINAL_MULTIPLE, EVOLUTIONARY_LENGTH, NUM_EVOL_LENGTHS, memory_delta, strategy_delta, breeding_delta, MAX_EVOL_MEMORY, MIN_EVOL_MEMORY, MAX_NUM_STRATEGIES, MIN_NUM_STRATEGIES);
    thermal_write_memory_evolutionary_mg_observables(RUN_TIME, NUM_STRATEGIES_PER_AGENT, RNG_SEED, MAX_AGENT_POP, INIT_MEMORY, MEM_DELTA_FINAL_MULTIPLE, EVOLUTIONARY_LENGTH, NUM_EVOL_LENGTHS, memory_delta, strategy_delta, breeding_delta, MAX_EVOL_MEMORY, MIN_EVOL_MEMORY, MAX_NUM_STRATEGIES, MIN_NUM_STRATEGIES);
    return 0;
}